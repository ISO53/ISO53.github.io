...
const experiences = [
    {
        ...
        img: "res/mobilvery.png",
        short_desc:
            "System Architect and Backend Developer at Mobilvery, accountable for formulating application logic, creating api's, ensuring system security etc. for the Mobilvery Web Application.",
        long_desc:
            "System Architect and Backend Developer at Mobilvery, responsible for designing and implementing application logic, developing APIs, and ensuring system security for the Mobilvery Web Application. Key technologies used include Java Spring Boot for backend development, Spring Security with JWT for authorization, Docker for containerization and deployment, and MongoDB for database management. Additionally, I oversaw the integration of RESTful services, implemented caching strategies, and ensured seamless scalability and performance optimization of the application.",
    ...
    },
    {
        ...
        short_desc:
            "I led the development for a curtain-selling website using WooCommerce. My focus on secure payment integration, SEO, and cache management enhanced performance and growth.",
        long_desc:
    ...
    },
    {
        ...
        short_desc:
            "I designed a dynamic curtain sales website using JavaScript, CSS, and HTML. It featured interactivity, SEO optimization, and reliable hosting.",
        long_desc:
    ...
    },
    {
        ...
        short_desc:
            "This internship enhanced my technical skills, especially in areas like backend and web development and database management, which will be valuable in my future work.",
        long_desc:
    ...
    },
    {
        ...
        short_desc:
            "I created a product catalog website using HTML, CSS, and JS, hosted it on Natro's reliable platform, and gained Linux-based cPanel expertise.",
        long_desc:
...
function interactiveExperiencesScrollBar() {
    ...
    function loadNewExperience(direction) {
        ...
        setTimeout(() => {
            document.getElementById("secondary_header").innerHTML =
                experiences[index].company.split(" ")[0] + " • " + experiences[index].position;
